class SceneManagement{
    ...
    InitHierarchy() {
        ...
        var font = this.loader.parse(fontJson);
        var _textSetting = {
            size: 5,
            height: 5,
            weight: 1,
        ...
        this.hierarchy["Text"] = new TextGeom({position: new THREE.Vector3(-5, 0, 0),
                                        setting: _textSetting});
    ...
    Update(){
        ...
        // this.hierarchy.ConvexHull.Rotate(this.rotateRate);
        // this.hierarchy.Lathe.Rotate(this.rotateRate);
        // this.hierarchy.Extrude.Rotate(this.rotateRate);
        // this.hierarchy.Tube.Rotate(this.rotateRate);
        // this.hierarchy.SVG.Rotate(this.rotateRate);
        // this.hierarchy.Parametric.Rotate(this.rotateRate);
        this.hierarchy.Text.Rotate(this.rotateRate);
